...
def main() -> int:
    ...
    for brief in briefs:
        try:
            ...
            logger.info("Generated assignment package for %s -> %s", brief.name, target_dir)
        except Exception:
    ...
    if errors:
        ...
        logger.info(
            "Done. The generated .docx contains a draft with analysis, "
            "Harvard citations, tables, and figures. "
            "Humanise the language before submission."
        )
